...
struct Math {
    ...
    static func percentIncreasing(value: Float, minimum: Float, maximum: Float) -> Float {
    ...
    nonisolated(unsafe) private static var quadListX = [Float](repeating: 0.0, count: 4)
    nonisolated(unsafe) private static var quadListY = [Float](repeating: 0.0, count: 4)
    ...
    static func easeInOutSine(percent: Float) -> Float {
    ...
    static func angleToVector(radians: Float) -> Point {
        .init(x: sinf(radians), y: -cosf(radians))
    }
    
    static func face(target: Point) -> Float {
        -atan2f(Float(-target.x), Float(-target.y))
    }
    
    static func rotatePoint(point: Point, radians: Float) -> Point {
    ...
    static func transformPoint(point: Point, scale: Float, rotation: Float) -> Point {
        var x = point.x
        var y = point.y
        if scale != 1.0 {
            x *= scale
    ...
    static func transformPoint(point: Point, translation: Point, scale: Float, rotation: Float) -> Point {
    ...
    static func untransformPoint(point: Point, scale: Float, rotation: Float) -> Point {
        transformPoint(point: point, scale: 1.0 / scale, rotation: -rotation)
    }
    
    static func untransformPoint(point: Point, translation: Point, scale: Float, rotation: Float) -> Point {
    ...
    */
    ...
    static func segmentClosestPoint(x: Float, y: Float,
    ...
    static func segmentClosestPointDistanceSquared(x: Float, y: Float,
                                                   linePoint1X: Float, linePoint1Y: Float,
